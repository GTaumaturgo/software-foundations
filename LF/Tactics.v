...
Theorem silly_ex :
     ...
     evenb 4 = true.
Proof.
  intros eq condition . apply condition.
Qed.
...
Example inversion_ex3 : forall (X : Type) (x y z w : X) (l j : list X),
  ...
  x = y.
Proof.
  intros X x y z w l j H1 H2.
  inversion H1. inversion H2. symmetry. apply trans_eq with (x). 
  - symmetry. apply H5.
  - apply H0.
Qed.
...
(*
Theorem double_m_o : forall m : nat, 0 = m1 + m2 -> m1 = 0. 
Proof. 
  induction m.
  - simpl. reflexivity.
